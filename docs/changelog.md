...
### [디자인 및 텍스트 스타일 개선]
- **브랜드 로고 테두리 제거 및 50% 추가 확대 (`92px`)**:
  - 사용자 피드백을 반영하여 로고 주변의 골드 테두리(`border`)와 그림자 박스를 완전히 제거하여 플로팅 형태의 깔끔한 디자인으로 개편.
  - 가독성 극대화를 위해 로고 높이를 기존 `62px`에서 `92px`로 **50% 확대** 및 네비게이션 헤더 높이(`106px`) 최적화.
  - 관련 파일: [`Homepage.jsx`](file:///c:/Users/%EA%B3%BD%EA%B2%BD%EB%82%A8/Desktop/home%20page/home%20page/src/components/Homepage.jsx), [`Admin.jsx`](file:///c:/Users/%EA%B3%BD%EA%B2%BD%EB%82%A8/Desktop/home%20page/home%20page/src/components/Admin.jsx)
- **히어로 배너 헤드라인 색상 변경**:
